    ...
    <div className={styles.strengthWrap}>
      ...
      <div className={styles.strengthChecks}>
        {checks.map((c) => (
          <span
            key={c.label}
            className={`${styles.strengthCheck} ${c.ok ? styles.checkOk : ""}`}
          >
...
export default function AuthPage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      if (mode === "signup") {
        // Store pending user data in sessionStorage for location page
        const pendingUser = {
          email: form.email,
        ...
        // Redirect to location page to complete signup
        setDone(true);
        ...
        <div className={styles.form}>
          ...
          {mode === "signup" && (
            <div className={styles.field}>
              <label className={styles.label} htmlFor="beavr-name">
                Full name
              </label>
              <input
                id="beavr-name"
              ...
              />
              {errors.name && (
                <span id="err-name" className={styles.errMsg}>
                  {errors.name}
                </span>
              )}
            </div>
          ...
          {/* Email */}
          <div className={styles.field}>
            <label className={styles.label} htmlFor="beavr-email">
              Email
            </label>
            <input
              id="beavr-email"
            ...
            />
            {errors.email && (
              <span id="err-email" className={styles.errMsg}>
                {errors.email}
              </span>
            )}
          </div>
          ...
          <div className={styles.field}>
            <div className={styles.labelRow}>
              <label className={styles.label} htmlFor="beavr-pw">
                Password
              </label>
              {mode === "signin" && (
            ...
            <div
              className={`${styles.pwWrap} ${errors.password ? styles.inputError : ""}`}
            >
              <input
                id="beavr-pw"
            ...
            {errors.password && (
              <span id="err-pw" className={styles.errMsg}>
                {errors.password}
              </span>
            )}
